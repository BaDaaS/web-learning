...
Enabling cross-origin isolation prevents loading resources from other origins
unless they explicitly opt-in with CORP headers. This can break third-party
integrations.
:::
